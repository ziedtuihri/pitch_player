...
public class NotificationListFXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Create a new message circle with a title
        String messageTitle = "New Message";
        Label messageCircle = new Label(messageTitle);
        messageCircle.getStyleClass().add("message-circle");

        // Add the message circle to the container
        idmessageContainer.getChildren().add(messageCircle);
