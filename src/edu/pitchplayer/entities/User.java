...
public class User {
    ...
    private String code;
    private String role;
    private byte[] picture; //added field profile picure
    ...
    public User(String username, String nom, String prenom, String email, String pwd, String adresse, String phone, int height, int weight, String profile, String role, byte[] picture, Equipe equipe) {
        this.username = username;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
