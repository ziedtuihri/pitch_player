...
public class Reclamation {
    ...
    public Reclamation(String date, String sujet, String objet, String statut, User user, String messageTraitement) {
        this.date = date;
        this.sujet = sujet;
        this.objet = objet;
        this.statut = statut;
    ...
    public Reclamation(int id, String date, String sujet, String objet, String statut, User user, String messageTraitement) {
        this.id = id;
        this.date = date;
        this.sujet = sujet;
        this.objet = objet;
